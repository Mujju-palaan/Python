...
raw_input()
#Question 1
question_1 = raw_input('Which is the largest ocean in the world?' + '\n')
...
raw_input()
#Question 2
question_2 = raw_input('Where is the worlds largest house located?' + '\n')
if question_2 =='mumbai' or question_2 =='Mumbai' or question_2 =='Bombay' or question_2 =='bombay':
    ...
    raw_input()
#Question 3
question_3 = raw_input('What is the smallest country in the world?' + '\n')
